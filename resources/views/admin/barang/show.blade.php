        ...
        <div class="col-md-6">
            ...
            @elseif($barang->fotoBarangs->count() === 1)
                <img src="{{ asset('storage/' . $barang->fotoBarangs->first()->file_path) }}"
                    ...
                    style="max-height:350px; object-fit:contain; background:#f8f9fa;" alt="">
            @else
            ...
            <div class="card admin-card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <span
                            class="badge badge-status bg-{{ $barang->status === 'tersedia' ? 'success' : ($barang->status === 'booking' ? 'warning' : 'secondary') }} fs-6">
